...
public class AdvancedMath {
	...
	/**
	 * An equation accepts a polynomial as a string in the form ax^b+cx^d-ex^f+g
	 * It represents a mathematical equation
	 * 
	 * @author Kylec
	 *
	 */
	public static class Equation {
		...
		private List<Double> parseEquation(String equation) {
			...
			for (int i = 0; i < equation.length(); i++) {
				...
				} else if (i >= 1 && isPartOfNumber(equation.charAt(i - 1))) {
	 ...
	 * @return
	 */
	private static boolean isPartOfNumber(char symbol) {
