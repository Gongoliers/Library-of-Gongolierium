...
import com.thegongoliers.output.MockSmartDrivetrain;
...
public class FollowPathCommandTest {
    ...
    public void convertsPathWaypointsToPath(){
        ...
        MockSmartDrivetrain mockSmartDrivetrain = new MockSmartDrivetrain();

        Path outputPath = new Path(mockSmartDrivetrain);
        ...
        assertEquals(outputPath, FollowPathCommand.waypointsToPath(mockSmartDrivetrain, waypoints, 90));
        ...
        outputPath = new Path(mockSmartDrivetrain);
        outputPath.addStraightAway(10);
        outputPath.addRotation(90);
        outputPath.addStraightAway(10);
        outputPath.addRotation(135);
